// app/soluciones/automatizacion-documental-ocr/page.tsx
"use client"

import Link from "next/link"
import { ArrowLeft, Sparkles, FileSearch, Construction, Clock } from "lucide-react"

export default function AutomatizacionDocumentalOCRPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 pt-32 pb-20 min-h-[calc(100vh-200px)] flex items-center justify-center">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#5a45a5]/20 to-[#c41e7a]/20 flex items-center justify-center mx-auto mb-6">
            <Construction className="w-12 h-12 text-[#5a45a5]" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Automatización{" "}
            <span className="bg-gradient-to-r from-[#5a45a5] to-[#c41e7a] bg-clip-text text-transparent">
              Documental OCR
            </span>
          </h1>
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Estamos trabajando en esta solución para ofrecerte la mejor experiencia en reconocimiento y extracción de datos.
          </p>
          ...
          <Link href="/contacto">
            <button className="mt-8 px-8 py-3 rounded-full bg-gradient-to-r from-[#5a45a5] to-[#c41e7a] text-white font-semibold hover:shadow-lg transition hover:scale-105">
