import { Check, FileText, Upload, FileOutput, Send } from "lucide-react"
import { Card, CardContent } from "@/components/ui/card"

const benefits = [
  "Eliminar la emisión manual de finiquitos.",
  "Eliminar la carga manual de finiquitos en la DT.",
  "Disminuir los errores propios de una tarea manual.",
  "Enfocar a tu equipo en actividades que realmente agreguen valor."
]

const workflowSteps = [
  { icon: FileText, label: "Captura de Información" },
  { icon: FileOutput, label: "Generación de Finiquitos" },
  { icon: Upload, label: "Carga en DT" },
  { icon: Send, label: "Reporte de Proceso" }
]

export function SolutionFiniquitos() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Emisión de Finiquitos y Carga en DT
          </h2>
        </div>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="p-8">
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Automatizamos el proceso de captura de información para generar finiquitos y realizar su carga en la DT.
                </p>
                <p>
                  Luego de realizado el proceso te entrega un reporte en el cual se alerta si hubo algún inconveniente como por ejemplo caída de la página de la DT, etc.
                </p>
              </div>
            </CardContent>
          </Card>
